...
$( document ).ready(function() {
	...
	$('#about').html('<h4>About the project</h4><img class="close-overlay" src="img/cross_white.png" /><div class="content"><p>software engineering projects</p>');
	$('#team').html('<h4>The team</h4><img class="close-overlay" src="img/cross_white.png" /><div class="content"><p>Nhom gom 4 thanh vien</p><p><strong><span style="line-height: 200%;">Project leader</span></strong><br/>Thu Hoai</a>, Lecturer, SoC, NUS</p><p><strong><</p>');
	//overlays stuff
