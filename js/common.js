...
$( document ).ready(function() {
	...
	$('#team').html('<h4>The team</h4><img class="close-overlay" src="img/cross_white.png" /><div class="content"><p><strong><span style="line-height: 200%;">trưởng nhóm</span></strong><br/><a href="#" target="_blank">Trần Thị Thu Hoài</a></p><p><strong><span style="line-height: 200%;">Thành viên</span></strong><br/><a href="#" target="_blank">Nguyễn Thu Thảo</a><br/><a href="#" target="_blank">Nguyễn Hải Anh</a><br/><a href="#" target="_blank">Phạm Văn Mẽ</a></div>');
	
	$('#termsofuse').html('<h4>Terms of use</h4><img class="close-overlay" src="img/cross_white.png" /><div class="content"><p>Nếu bạn đang học về cấu trúc dữ liệu và thuật toán, bạn được phép sử dụng trang web này. Bạn có thể chụp ảnh màn hình từ trang web này và sử dụng ảnh chụp màn hình ở nơi khác miễn là bạn trích dẫn trang web này làm tài liệu tham khảo.</div>');
